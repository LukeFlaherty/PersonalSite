		...
		<Container>
			...
			>
				...
				<Box>
					...
					<Text as="ul" variant="list" sx={{ lineHeight: 1.75 }}>
						<li>
							<FooterLink href="https://github.com/LukeFlaherty" external>
								GitHub
							</FooterLink>
						</li>

						<li>
							<FooterLink href="https://twitter.com/lukejflaherty" external>
								Twitter
							</FooterLink>
						</li>
						...
						<li>
							<FooterLink href="https://codepen.io/lukeflaherty" external>
								CodePen
							</FooterLink>
						</li>
