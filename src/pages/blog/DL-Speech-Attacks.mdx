...
export const meta = {
	...
	description:
		"Our voice conveys so much more than the words we speak, it is a fundemental part of our identity.  Perhaps the human voice is no longer as unique as we are used to.  Hear about how DL can take this identifier away from you.",
}
